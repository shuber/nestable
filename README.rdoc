...
Allows you to nest ActiveRecord items with various theories like tree, set, graph, etc.
...
down the road just because you realized that you're better off storing records as a set instead of a tree.
